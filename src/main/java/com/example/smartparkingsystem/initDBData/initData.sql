...
-- ===================== 2026년 (45건, 45%) =====================
('78차9012', '너울파', '010-3927-6184', '2026-01-02', '2026-02-01', 100000),
('912카3456', '더나은', '011-8293-4716', '2026-01-05', '2026-02-04', 100000),
('34타7890', '러일출', '010-4716-8293', '2026-01-08', '2026-02-07', 100000),
('567파1234', '머루알', '011-7384-2916', '2026-01-11', '2026-02-10', 100000),
('89하5678', '버드나', '010-2916-7384', '2026-01-14', '2026-02-13', 100000),
('123거9012', '서리꽃', '011-5827-1394', '2026-01-17', '2026-02-16', 100000),
('45너3456', '어깨동', '010-1394-5827', '2026-01-20', '2026-02-19', 100000),
('678더7890', '저녁놀', '011-9261-4738', '2026-01-23', '2026-02-22', 100000),
('89러1234', '초록빛', '010-4738-9261', '2026-01-26', '2026-02-25', 100000),
('123머5678', '크리스', '011-3849-7162', '2026-01-29', '2026-02-28', 100000),
('56버9012', '트리온', '010-7162-3849', '2026-02-01', '2026-03-03', 100000),
('789서3456', '푸른봄', '011-6273-1948', '2026-02-03', '2026-03-05', 100000),
('23어7890', '하람이', '010-1948-6273', '2026-02-05', '2026-03-07', 100000),
('456저1234', '가람빛', '011-8362-4917', '2026-02-07', '2026-03-09', 100000),
('78처5678', '나루터', '010-4917-8362', '2026-02-09', '2026-03-11', 100000),
('912커9012', '다솜이', '011-2794-6381', '2026-01-03', '2026-02-02', 100000),
('34터3456', '라온삶', '010-6381-2794', '2026-01-06', '2026-02-05', 100000),
('567퍼7890', '마루치', '011-4916-8273', '2026-01-09', '2026-02-08', 100000),
('89허1234', '바솔빛', '010-8273-4916', '2026-01-12', '2026-02-11', 100000),
('123고5678', '사계절', '011-3618-7294', '2026-01-15', '2026-02-14', 100000),
('45노9012', '아리수', '010-7294-3618', '2026-01-18', '2026-02-17', 100000),
('678도3456', '자리끼', '011-1847-5392', '2026-01-21', '2026-02-20', 100000),
('89로7890', '차오름', '010-5392-1847', '2026-01-24', '2026-02-23', 100000),
('123모1234', '카나리', '011-9273-6184', '2026-01-27', '2026-02-26', 100000),
('56보5678', '타임리', '010-6184-9273', '2026-01-30', '2026-03-01', 100000),
('789소9012', '파도소', '011-4839-2716', '2026-02-02', '2026-03-04', 100000),
('23오3456', '하온별', '010-2716-4839', '2026-02-04', '2026-03-06', 100000),
('456조7890', '거센빛', '011-7492-3816', '2026-02-06', '2026-03-08', 100000),
('78초1234', '너름세', '010-3816-7492', '2026-02-08', '2026-03-10', 100000),
('912코5678', '더없이', '011-8174-2639', '2026-02-10', '2026-03-12', 100000),
('34토9012', '러브유', '010-2639-8174', '2026-02-12', '2026-03-14', 100000),
('567포3456', '마음결', '011-6392-4817', '2026-02-14', '2026-03-16', 100000),
('89호7890', '바람개', '010-4817-6392', '2026-01-04', '2026-02-03', 100000),
('123가1357', '사름이', '011-2948-7163', '2026-01-07', '2026-02-06', 100000),
('45나2468', '아련함', '010-7163-2948', '2026-01-10', '2026-02-09', 100000),
('678다3579', '자유인', '011-5284-9173', '2026-01-13', '2026-02-12', 100000),
('89라4680', '차가운', '010-9173-5284', '2026-01-16', '2026-02-15', 100000),
('123마5791', '카운트', '011-3716-8492', '2026-01-19', '2026-02-18', 100000),
('56바6802', '타오름', '010-8492-3716', '2026-01-22', '2026-02-21', 100000),

-- ===================== 중복 회원 5건 (기존 차량번호 재등록 - 회원권 연장) =====================
('12가1234', '김민준', '010-3827-5941', '2024-02-05', '2024-03-06', 100000),  -- 원본 만료일 다음날 재등록
('45다9012', '박지호', '010-8163-4752', '2024-03-10', '2024-04-09', 100000),  -- 원본 만료일 다음날 재등록
