                        ...
                        <div class="mb-2">
                            ...
                            <div class="row g-2" role="group">
                                <div class="col">
                                    ...
                                    <label class="btn btn-outline-primary w-100 py-3 fw-bold" for="type1"
                                           style="border-radius: 12px;">일반</label>
                                </div>
                                <div class="col">
                                    <input type="radio" class="btn-check" name="carType" id="type2" value="경차">
                                    <label class="btn btn-outline-primary w-100 py-3 fw-bold" for="type2"
                                           style="border-radius: 12px;">경차</label>
                                </div>
                                <div class="col">
                                    <input type="radio" class="btn-check" name="carType" id="type3" value="장애인">
                                    <label class="btn btn-outline-primary w-100 py-3 fw-bold" for="type3"
                                           style="border-radius: 12px;">장애인</label>
                                </div>
                            </div>
                        </div>
                    </div>
