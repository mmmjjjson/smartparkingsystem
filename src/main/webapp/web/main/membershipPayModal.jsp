  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header bg-primary text-white">
        <h5 class="modal-title fw-bold">회원권 신규/연장 결제</h5>
        ...
        <div id="mem-input-section">
          <div class="mb-3">
            ...
            <div class="input-group">
              <input type="text" id="mem-carNum" class="form-control">
              <button class="btn btn-outline-secondary" type="button" id="btn-check-member">회원 확인</button>
            </div>
          </div>

          <div class="mb-3">
            <label class="form-label fw-bold">이름</label>
            <input type="text" id="mem-name" class="form-control">
          </div>

          <div class="mb-3">
            <label class="form-label fw-bold">연락처</label>
            <input type="text" id="mem-phone" class="form-control">
          </div>

          <div class="row">
            <div class="col-6 mb-3">
              <label class="form-label fw-bold">시작일</label>
              <input type="date" id="mem-startDate" class="form-control" readonly>
            </div>
            <div class="col-6 mb-3">
              <label class="form-label fw-bold">만료일</label>
              <input type="date" id="mem-endDate" class="form-control" readonly>
            </div>
          </div>

          <div class="mb-3">
            <label class="form-label fw-bold">총 결제 요금</label>
            <input type="text" id="mem-price" class="form-control fw-bold text-primary" value="100,000원" readonly>
          </div>
        </div>
