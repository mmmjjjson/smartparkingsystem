...
<head>
    ...
    <style>
        ...
        .box-id { position:absolute; top:6px; left:6px; font-size:11px; }
        .box-car { position:absolute; top:50%; left:50%; transform:translate(-50%,-50%); font-size:18px; font-weight:bold; }
        .box-time { position:absolute; bottom:6px; left:50%; transform:translateX(-50%); font-size:10px; color:#555; }
